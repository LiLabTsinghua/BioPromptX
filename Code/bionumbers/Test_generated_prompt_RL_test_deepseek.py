...
if __name__ == '__main__':
    ...
    prompts = load_prompts_from_excel(excel_file_path, header_col1, header_col2)

    # Load multiple articles from JSON file
    json_file_path = 'Length Scales Inside Cells_results_new.json'  # Replace with your JSON file path
    ...
    for paper in papers:
        ...
        Initial_Prompt_extracted_data = paper["Initial_Prompt_extracted_data"]
        ...
        results.append({
            ...
            "Initial_Prompt_extracted_data": Initial_Prompt_extracted_data,  # Parse the JSON string to a dictionary
            "RL_Prompt_extracted_data": json.loads(extracted_data)
        })
