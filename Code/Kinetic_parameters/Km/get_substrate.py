...
def locate_kinetic_parameter_prompt(text, parameter_type, parameter_value):
    ...
    prompt = f"""
        Text: ''' {text} '''
        Based on the above text, locate the substrate associated with the given kinetic parameter Km.
...
if __name__ == '__main__':
    process_json('Ecoli_kinetic_combined.json', "Ecoli_kinetic_combined_substrate.json")
