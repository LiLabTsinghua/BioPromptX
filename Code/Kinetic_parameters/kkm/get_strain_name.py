...
def locate_full_substrate_name_prompt(text, parameter_value, enzyme):
    ...
    prompt = f"""
        Text: ''' {text} '''
        Based on the above text, the following enzyme kinetic parameter kcat/Km value and key gene of corresponding enzyme has been extracted.

        kcat/Km value: {parameter_value}
        Key gene of the enzyme: "{enzyme}"

        Your task is to find the strain name corresponding to the enzyme and kcat/Km value I provided in the article.
