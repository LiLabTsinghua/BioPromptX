...
def qwen_api(user_message, port=8000, top_p=0.9, temperature=0.5, system_message='', max_tokens=4096):
    ...
    try:
        ...
        response = client.chat.completions.create(
            # model="/home/zhetao/.cache/modelscope/hub/openai-mirror/gpt-oss-120b",  # 模型路径
            # model="/home/xiongwen/Llama3.1_8B_NER",
            model="/home/zhetao/.cache/modelscope/hub/LLM-Research/Llama-3.3-70B-Instruct",
            messages=history,
