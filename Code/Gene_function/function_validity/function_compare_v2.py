...
if __name__ == '__main__':
    # 定义输入和输出的TSV文件路径
    input_file = '/home/zhetao/Human_gene/Info_Extration/gene_function/Get_Function/split200_gene_function/final_result/carbon_result_gene_DS32_comparison_checked_split_function_result.tsv'  # 替换为你的输入文件路径
    output_file = '/home/zhetao/Human_gene/Info_Extration/gene_function/Get_Function/split200_gene_function/final_result/carbon_result_gene_DS32_comparison_checked_split_function_result.tsv'  # 替换为你的输出文件路径
